        ...
        <div class="card p-5">
            ...
            <div class="from">
                ...
                <div class="logo-container text-center mb-3">
                    <img src="/otopark_otomasyonu-main/img/logo.png" alt="Logo"  style="max-width: 200px;">
                ...
                <form action="giris.php" method="post">
                    <div class="mb-3">
                        <input type="email" name="mail" class="form-control text-center" placeholder="Mail Giriniz" required><br>
                        <input type="password" name="sifre" class="form-control text-center" placeholder="Şifre Giriniz" required><br>
