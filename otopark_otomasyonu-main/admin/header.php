...
if (isset($_POST['bul'])) {
    ...
    // Aranan plakayı büyük harfe çevir ve boşlukları kaldır
    $bul = strtoupper(str_replace(' ', '', $bul));
    ...
    if (!$bul) {
        ...
        // Veritabanında plaka ile arama yaparken boşlukları ve harf duyarlılığını kaldırdık
        $plakabul = $db->prepare('SELECT * FROM arac_kayit WHERE REPLACE(UPPER(arac_plaka), " ", "") LIKE :arac_plaka');
